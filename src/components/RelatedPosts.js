...
const RelatedPosts = (props) => {
  ...
  return (<aside className='read-next outer'>
    <div className='inner'>
      <div className='read-next-feed'>
        <article className='read-next-card' style={{ backgroundImage: `url(${backgroundImage})` }}>
        ...
        {
          props.previousPost && <PostCard post={props.previousPost} rel='prev' />
        }
